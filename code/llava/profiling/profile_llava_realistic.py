"""Realistic-workload variant for LLaVA-1.5-7B: ~500-token prompt, fixed 336x336 image.
LLaVA-1.5 does not dynamic-tile, so the realistic axis here is prompt length only."""
import torch
import numpy as np
...
# ==========================================
# Long-prompt base (~500 tokens of multi-paragraph instruction)
# ==========================================
LONG_BASE = (
...
PROMPTS = [f"USER: <image>\n{LONG_BASE}{t}\nASSISTANT:" for t in TAILS]

# Fixed 336x336 (LLaVA-1.5 vision input size — no tiling).
