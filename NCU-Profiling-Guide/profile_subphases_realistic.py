"""Realistic-workload variant: ~500-token prompt + 896x896 image (target 4 tiles)."""
import torch
import numpy as np
...
# 5 distinct tail questions → 5 distinct full prompts (cache-defeat by content variation)
TAILS = [
...
# ==========================================
# Multi-tile image: upscale eer.jpg to 896x896 (target ~4 tiles for InternVL3)
# ==========================================
